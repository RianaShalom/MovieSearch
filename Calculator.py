...
Button = collections.namedtuple("Button", ["label", "colour", "x", "y", "length", "height"])
...
def make_buttons():
    ...
    buttons.append(Button("AC", BGREEN, x1, 139, length, width)) # Top row
    buttons.append(Button("POW", BGREEN, x2, 139, length, width))
